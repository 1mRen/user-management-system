...
const allowedOrigins = process.env.CORS_ORIGINS
  ...
  : ['https://user-management-system-6yrwvx8op-1mrens-projects.vercel.app/', 'https://user-management-system-pm.vercel.app','user-management-system-j0up52tis-1mrens-projects.vercel.app'];
app.use(cors({
